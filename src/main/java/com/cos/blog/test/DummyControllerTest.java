...
public class DummyControllerTest {
	...
	public User updateUser(@PathVariable int id, @RequestBody User requestUser) {//RequestBody는 json 데이터를 받기위해사용
																																		   //json 데ㅣ터를 요청 => Java Object(MessageConverter의 Jackson라이브러리가 변환해서 받아줘요.)
	...
	public User detail(@PathVariable int id) {
		//user/4을 찾으면 내가 데이터베이스에서 못찾아 오게되면 user가 null이 될것 아냐?
...
//		});
		...
		// user 오브젝트를 json으로 변환해서 브라우저에게 전져줍니다.
		return user;	
	}
